...
Data_Zones <-
  ...
  mutate(
    ...
    Alpha = 2.5514E-6,
    # The gravity model:
    Trips = Alpha * Population * city_total_trips * FrictionFactor
  )

#---- Visualisation ----
print(Data_Zones %>% select(Zone, Trips))
...
Auto_Cost_KM = 0.70 # 35c/km charge
